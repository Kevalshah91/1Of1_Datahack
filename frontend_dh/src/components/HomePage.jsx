...
import { FaRobot, FaBook, FaChartLine, FaUpload, FaBrain, FaLightbulb, FaGraduationCap, FaUserGraduate, FaClock, FaMobile, FaLaptop, FaCloudUploadAlt, FaChartBar, FaComments,FaCheck } from 'react-icons/fa';
...
const FeatureCard = ({ icon: Icon, title, description }) => {
  ...
  return (
    ...
    >
      ...
      <Icon className="text-4xl text-indigo-600 mb-4 group-hover:scale-110 transition-transform duration-300" />
...
const SpotlightCard = ({ title, description, icon: Icon }) => (
  <div className="relative p-6 bg-white rounded-xl shadow-lg overflow-hidden group">
    <div className="absolute inset-0 bg-gradient-to-br from-blue-400 to-indigo-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
    <div className="relative z-10">
      <Icon className="text-4xl text-indigo-600 group-hover:text-white transition-colors duration-300 mb-4" />
      <h3 className="text-xl font-semibold text-gray-800 group-hover:text-white transition-colors duration-300 mb-2">{title}</h3>
...
const Timeline = () => {
  const items = [
    { title: "Upload Materials", description: "Easily upload your study materials or textbooks.", icon: FaCloudUploadAlt },
    { title: "AI Processing", description: "Our advanced AI analyzes and processes your content.", icon: FaRobot },
    { title: "Generate Study Aids", description: "Receive personalized summaries, flashcards, and quizzes.", icon: FaLightbulb },
    { title: "Learn & Practice", description: "Use the generated materials to enhance your learning.", icon: FaUserGraduate },
    { title: "Track Progress", description: "Monitor your improvement and identify areas for focus.", icon: FaChartBar }
  ];
...
const HomePage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      {/* Hero Section */}
      <header className="relative overflow-hidden bg-gradient-to-r from-white to-indigo-100 text-blue-900">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          ...
          >
            ...
            <p className="mt-3 max-w-md mx-auto text-xl sm:text-2xl md:mt-5 md:max-w-3xl">
              Transform your study materials into interactive learning experiences tailored just for you.
            </p>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-indigo-800 text-white">
        <div className="max-w-4xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          ...
          <span className="block">Ready to revolutionize your learning?</span>
            <span className="block mt-2">Start using our AI Study Material Generator today.</span>
          </h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            {[
              { name: "Basic", price: "Free", features: ["AI-generated summaries", "Basic flashcards", "Limited quizzes"] },
              { name: "Pro", price: "$9.99/month", features: ["Everything in Basic", "Advanced concept maps", "Unlimited quizzes", "Progress tracking"] },
              { name: "Premium", price: "$19.99/month", features: ["Everything in Pro", "AI tutor chat", "Personalized study plans", "Virtual study groups"] }
            ].map((plan, index) => (
              <motion.div
                key={plan.name}
                initial={{ opacity: 0, y: 50 }}
              ...
              >
                <div className="px-6 py-8 sm:p-10 sm:pb-6">
                  ...
                  <div className="mt-4 flex items-baseline text-gray-900">
                    ...
                    {plan.name !== "Basic" && <span className="ml-1 text-xl font-semibold">/month</span>}
                  </div>
                </div>
                <div className="px-6 pt-6 pb-8 sm:p-10 sm:pt-6">
                  ...
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="mt-8 block w-full bg-indigo-600 text-white rounded-md py-3 px-6 text-center font-medium hover:bg-indigo-700"
                  >
                    Get started
                  </motion.button>
                </div>
      ...
      >
        <p className="text-gray-800 italic mb-4">"This AI-powered study tool has completely transformed my learning experience. I've never felt more prepared for exams!"</p>
